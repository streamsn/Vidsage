  ...
  return (
    <div className="fixed inset-0 z-20 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-6 text-center shadow-lg">
        ...
        <Link
          href="/pricing"
          className="mt-4 block rounded-xl bg-brand-600 px-4 py-3 text-sm font-medium text-white shadow-sm transition-colors hover:bg-brand-700 sm:py-2"
        >
          Buy credits
        </Link>
        <button
          onClick={onClose}
          className="mt-2 w-full rounded-xl px-4 py-2 text-sm font-medium text-stone-500 hover:text-stone-700"
        >
          Maybe later
        </button>
      </div>
